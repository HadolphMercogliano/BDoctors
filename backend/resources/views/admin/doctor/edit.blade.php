...
@section('content')
	<div class="container">
		...
		<form action="{{ route('doctor.update', $doctor) }}" method="POST" enctype="multipart/form-data" class="form-input-image">
			@csrf
			@method('PUT')
			<div class="mb-3">
			...
			<div class="mb-3">
				...
				<input type="text" class="form-control" id="address" name="address" placeholder="Inserisci indirizzo dottore"
					required minlength="1" maxlength="100" value="{{ old('address', $doctor->address) }}">
			</div>

			<div class="mb-3">
				<label for="curriculum_vitae" class="form-label">CV:</label>
				<input type="text" class="form-control" id="curriculum_vitae" name="curriculum_vitae" placeholder="Inserisci CV"
					required minlength="1" maxlength="100" value="{{ old('curriculum_vitae', $doctor->curriculum_vitae) }}">
			</div>
			...
			<input class="form-check-input" type="checkbox" id="visible" value="1" name="visible"
				@checked(old('visible', $doctor->visible))>
			...
			<div class="mb-3 @if (!$doctor->photo) d-none @endif" id="image-input-container">
				...
				<input class="form-control" type="file" id="photo" name="photo" value="{{ old('photo', $doctor->photo) }}">
			</div>
			{{-- /immagini --}}
