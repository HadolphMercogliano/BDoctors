	...
	<div class="container">
		...
		<div class="container pt-4">
			<div class="row">
				...
				<form action="{{ route('admin.doctor.store') }}" method="POST" enctype="multipart/form-data" class="form-input-image">
					{{-- token laravel form --}}
					@csrf
					{{-- token --}}
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="address" name="address" placeholder="Inserisci indirizzo dottore"
							required minlength="1" maxlength="100" value="{{ old('address') }}">
					</div>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="curriculum_vitae" name="curriculum_vitae" placeholder="Inserisci CV"
							required minlength="1" maxlength="100" value="{{ old('curriculum_vitae') }}">
					</div>
